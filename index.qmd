...
No, not at all. Intellectual property (IP) is covered by the [IP regulations](https://www.southampton.ac.uk/about/governance/regulations-policies/general-regulations/intellectual-property). Copyright in the Work is being granted to the University, but this does not limit any of your rights, including IP. The IP Regulations were changed because the wording  in one section had potential to cause confusion with respect to rights granted to the institution with respect to Journal Articles and Conference proceedings.
:::
